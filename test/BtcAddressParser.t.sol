...
contract TestBtcAddressParser is Test {
    ...
    function test_getP2TRKeyPathScriptPubKey_Success() external pure {
        // Arrenge
        bytes32 publicKey = 0x0908421cb37d204b0c68660d093534d50d01fa791a3313e5fd9c21da137785eb;
        // Act
        bytes memory scriptPubKey = BtcAddressParser.getP2TRKeyPathScriptPubKey(publicKey);
        // Assert
        assertEq(
            scriptPubKey,
            hex"5120f8bc2bbb52031daee28da58481e8ec3b045202ed9213b62bf33e221d31b3e6ef",
            "getP2TRKeyPathScriptPubKey should give the correct Script public key"
        );
    }

    function test_getP2TRScriptPathScriptPubKey_Success() external pure {
        // Arrenge
        ...
        // Act
        bytes memory scriptPubKey = BtcAddressParser.getP2TRScriptPathScriptPubKey(publicKey, merkleRoot);
        // Assert
        assertEq(
            scriptPubKey,
