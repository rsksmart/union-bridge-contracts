...
def test_p2tr(rpc, secret_key_from, address_from, address_to, funding_txid, fee):
    ...
    tr_script_p2pk = Script([reimbursement_public_key.to_x_only_hex(), "OP_CHECKSIG"])
    print("Script:", tr_script_p2pk)

    fromAddress = pub.get_taproot_address([[tr_script_p2pk]])
    ...
    control_block = ControlBlock(pub, scripts=[tr_script_p2pk], index=0, is_odd=fromAddress.is_odd())

    tx.witnesses.append(TxWitnessInput([
        sig,
        tr_script_p2pk.to_hex(),
